...
1. [ ] single number metric for performance/accuracy in markdown report
1. [ ] P-value for accuracy change in markdown report
...
#### 2. experiment-2
- [x] json in prompt
- [ ] waiting for 72 chemicals to complete
- [ ] run eval.py on experiment-2 data
- [ ] review summary.json and maybe a few _ files
- [ ] generate markdown
